      ...
      {large ? (
        <>
          <textarea
            ...
            } flex-grow bg-tangaroa-50 placeholder:italic placeholder:text-tangaroa-600/60 border-tangaroa-950 peer  p-2 focus:outline-none text-tangaroa-950 focus:ring-1  focus:ring-tangaroa-600/60 order-34 rounded-sm `}
          />
        </>
      ) : (
        <>
